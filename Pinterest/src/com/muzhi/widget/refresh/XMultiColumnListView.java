...
public class XMultiColumnListView extends MultiColumnListView implements OnScrollListener {
//    private static final String TAG = "XListView";
    ...
    public XMultiColumnListView(Context context, AttributeSet attrs, int defStyle) {
